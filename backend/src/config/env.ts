...
if (!JWT_SECRET) {
  ...
  // No bloquea el arranque para no invalidar despliegues/sesiones existentes,
  // pero se recomienda rotarlo a un secreto de >= 32 caracteres aleatorios.
  warnings.push(
    'JWT_SECRET tiene menos de 32 caracteres. Se recomienda rotarlo a uno más largo y aleatorio.'
  );
}
