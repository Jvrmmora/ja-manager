      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
          ...
          <div className="text-center py-12">
            ...
            {userInfo?.placa && (
              <div className="inline-flex items-center px-4 py-2 bg-blue-100 text-blue-800 rounded-lg mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-12">
              <div className="bg-gray-50 border-2 border-dashed border-gray-300 rounded-lg p-8 text-center">
                ...
                <p className="text-gray-600">Nuevas funcionalidades estarán disponibles pronto</p>
              </div>
              ...
              <div className="bg-gray-50 border-2 border-dashed border-gray-300 rounded-lg p-8 text-center">
                ...
                <p className="text-gray-600">Más contenido se agregará aquí</p>
              </div>

              <div className="bg-gray-50 border-2 border-dashed border-gray-300 rounded-lg p-8 text-center md:col-span-2 lg:col-span-1">
                <svg className="w-12 h-12 text-gray-400 mx-auto mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                </svg>
                <h3 className="text-lg font-medium text-gray-900 mb-2">Funciones Avanzadas</h3>
                <p className="text-gray-600">Características especiales próximamente</p>
              </div>
            </div>
          </div>
        </div>
