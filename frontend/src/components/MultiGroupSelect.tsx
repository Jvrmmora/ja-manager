    ...
    <div className={className} ref={ref}>
      <div className="relative">
        <button
          ...
          className="w-full border border-gray-300 dark:border-gray-600 rounded-lg px-3 py-2 text-sm sm:text-base bg-white dark:bg-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 focus:border-transparent transition-colors"
        >
              ...
              >
                <div className="flex items-center">
                  <input
                    ...
                    readOnly
                    className="w-4 h-4 text-blue-600 bg-gray-100 dark:bg-gray-600 border-gray-300 dark:border-gray-500 rounded focus:ring-blue-500 dark:focus:ring-blue-400 pointer-events-none"
                  />
                </div>
