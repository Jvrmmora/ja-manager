                ...
                <div className="ml-3">
                  ...
                  <div className="mt-2 text-sm text-red-700 dark:text-red-300">
                    <ul className="list-disc list-inside space-y-1">
                      {isActive && (
                        <li className="font-semibold">Esta temporada está ACTIVA actualmente</li>
                      )}
                      <li>Esta acción no se puede deshacer</li>
                      <li>Se eliminarán todos los puntos de esta temporada de cada joven</li>
                      <li>Se eliminarán todas las rachas de esta temporada</li>
                      <li>Se eliminarán todas las asistencias registradas en esta temporada</li>
                      <li>Se perderán todos los datos de la temporada permanentemente</li>
                    </ul>
                  </div>
                </div>
              </div>
