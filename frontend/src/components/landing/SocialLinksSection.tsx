...
export default function SocialLinksSection({
  ...
  const socialLinks: SocialLink[] = [
    ...
    },
    {
      ...
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
          <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.67-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.076 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421-7.403h-.004a9.87 9.87 0 00-5.031 1.378c-3.055 2.309-3.635 6.349-1.326 9.404 2.309 3.055 6.349 3.635 9.404 1.326 3.055-2.309 3.635-6.349 1.326-9.404-1.552-2.051-4.069-3.27-6.679-3.704m0-2.081a11.951 11.951 0 018.217 3.407c4.147 4.147 4.572 10.519 1.067 15.025-3.505 4.506-9.876 4.931-14.023.784C.146 20.58.722 14.208 4.227 9.703 8.375 5.556 14.746 5.13 18.893 8.298" />
        </svg>
      ),
    },
  ];
